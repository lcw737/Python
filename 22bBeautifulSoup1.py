...
# '파이썬 웹크롤링'으로 검색한 인코딩 처리된 주소(한글로 넣어도 됨) (장마)

url = 'https://kin.naver.com/search/list.naver?query=장마'
...
if response.status_code == 200:
    ...
    # 셀럭터로 파싱(파이어폭스) : 셀렉터의 결과는 다르지만 크롤링의 결과는 동일하다. 
    ...
    titles_2 = ul.select('li > dl > dt > a')
    for tit in titles_2:
        # 검색 결과의 텍스트만 파싱해서 출력한다. 
      print(tit.get_text())

...
# driver.find_element(By.NAME, 'id').send_keys('lcw7372')
# time.sleep(2)
# driver.find_element(By.NAME, 'pw').send_keys('dlckddn737')
# time.sleep(2)
driver.find_element(By.NAME, 'id').send_keys('lcw737')
time.sleep(2)
driver.find_element(By.NAME, 'password').send_keys('dlckddn737!')
time.sleep(2)
